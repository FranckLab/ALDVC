...
%% Body view of solved displacements
...
%% Slice view of solved displacements
...
figure, imagesc3D(Ux); % There is no units in 'imagesc3D' function 
% Coordinates in this plot: going downwards is x+ direction, going right is y+ direction
...
view(2); axis equal; axis tight; set(gca,'fontsize',18); cb = colorbar;
title(['Solved x-disp at z-slice #',num2str(sliceNum),'  (unit:vx)'],'fontweight','normal');



%% Body view of solved strains
...
% ===================================
% If you want to plot strains after executing Section 8 (where additional modifications can be done)
...
view(2); axis equal; axis tight; set(gca,'fontsize',18); cb = colorbar;
title(['Strain exx at z-slice #',num2str(sliceNum),'  (unit:vx)'],'fontweight','normal');
